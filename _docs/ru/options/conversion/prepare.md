...
![Диалог настроек подготовки](/assets/images/options/conversion/prepare-1.png "Диалог настроек подготовки"){:class="img-fluid"}
...
![Пример направления сканирования](/assets/images/options/conversion/prepare-2.png "Пример направления сканирования"){:class="img-fluid"}

Для дисплея с такой памятью:

![Пример организации памяти дисплея](/assets/images/options/conversion/prepare-3.png "Пример организации памяти дисплея"){:class="img-fluid"}
