...
![Диалог настроек преобразования](/assets/images/options/conversion/index-1.png "Диалог настроек преобразования"){:class="img-fluid"}

По кнопке **Открыть предпросмотр** выводится окно с примером преобразования изображения в текст, учитывая текущие настройки. 

![Диалог предварительного просмотра](/assets/images/options/conversion/index-2.png "Диалог предварительного просмотра"){:class="img-fluid"}
