...
![Пункт в меню](/assets/images/fonts/new-1.png "Пункт в меню"){.img-responsive}
...
![Ввод названия](/assets/images/fonts/new-2.png "Ввод названия"){.img-responsive}
...
![Настройка шрифта](/assets/images/fonts/new-3.png "Настройка шрифта"){.img-responsive}

![Настройка шрифта](/assets/images/fonts/new-4.png "Настройка шрифта"){.img-responsive}

![Настройка шрифта](/assets/images/fonts/new-5.png "Настройка шрифта"){.img-responsive}

Помимо таблиц символов Юникода, символы могут быть выбраны из указанной кодировки. 

![Выбор из кодировки](/assets/images/fonts/new-6.png "Выбор из кодировки"){.img-responsive}
