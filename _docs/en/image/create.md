...
![Create new]({{ '/assets/images/image/new-1.png' | relative_url }} "Create new"){:class="img-fluid"}

Then you are needed to enter name of the file. This name will be used in result file, the name of the data structure.

![Naming]({{ '/assets/images/image/new-2.png' | relative_url }} "Naming"){:class="img-fluid"}
