...
![Matrix dialog]({{ '/assets/images/options/conversion/matrix/index-1.png' | relative_url }} "Matrix dialog"){:class="img-fluid"}
...
![Adding Shift operation]({{ '/assets/images/options/conversion/matrix/index-2.png' | relative_url }} "Adding Shift operation"){:class="img-fluid"}

Move or delete the existing operation is possible from its context menu.

![Changing operation]({{ '/assets/images/options/conversion/matrix/index-3.png' | relative_url }} "Changing operation"){:class="img-fluid"}

Masks "Used", "AND", "OR", "Fill" edited manually by entering "1" or "0" bit fields, or from the its context menu.

![Changing bits]({{ '/assets/images/options/conversion/matrix/index-4.png' | relative_url }} "Changing bits"){:class="img-fluid"}
