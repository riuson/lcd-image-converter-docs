...
![Пункт в меню]({{ '/assets/images/fonts/to-image-1.png' | relative_url }} "Пункт в меню"){:class="img-fluid"}

![Результат]({{ '/assets/images/fonts/to-image-2.png' | relative_url }} "Результат"){:class="img-fluid"}
