...
|                      |
 ...
 fnt_compacted         | включено (yes) или нет (no) сжатие шрифтов
|                      |
...
|                      | 
 ...
 out_char_code_min     | минимальный код символа в шестнадцатеричном виде
 out_char_code_max     | максимальный код символа в шестнадцатеричном виде
 ...
 out_char_image_left   | отступ слева изображения символа внутри знакоместа
 out_char_image_top    | отступ сверху изображения символа внутри знакоместа
 out_char_image_width  | ширина изображения символа
 out_char_image_height | высота изображения символа
 ...
 out_image_height      | высота изображения/знакоместа
 out_image_width       | ширина изображения/знакоместа
