...
![Диалог настроек подготовки]({{ '/assets/images/options/conversion/prepare-1.png' | relative_url }} "Диалог настроек подготовки"){:class="img-fluid"}
...
![Пример направления сканирования]({{ '/assets/images/options/conversion/prepare-2.png' | relative_url }} "Пример направления сканирования"){:class="img-fluid"}

Для дисплея с такой памятью:

![Пример организации памяти дисплея]({{ '/assets/images/options/conversion/prepare-3.png' | relative_url }} "Пример организации памяти дисплея"){:class="img-fluid"}
