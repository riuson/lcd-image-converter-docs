...
![Menu item]({{ '/assets/images/fonts/to-image-1.png' | relative_url }} "Menu item"){:class="img-fluid"}

![Result]({{ '/assets/images/fonts/to-image-2.png' | relative_url }} "result"){:class="img-fluid"}
